...
public final class FunctionArgumentsUtil {
  ...
  public static FunctionArgumentsAndContext getFunctionTypeInfo(
    ...
    if (!functionCall.hasLambdaFunctionCallArguments()) {
      ...
      for (int i = 0; i < arguments.size(); i++) {
        ...
        if (expression instanceof LambdaFunctionCall) {
          ...
          final TypeContext childContext = context.copyWithLambdaVariableTypeMapping(variableTypeMapping);
